package com.example.toearnfun_flutter_app.adapter;
...
public class DeviceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            holder.btn_api = (Button) convertView.findViewById(R.id.btn_api);
        }
        ...
        holder.btn_api.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mListener != null) {
                    mListener.onApi(bleDevice);
                }
            }
        });
    ...
    public interface OnDeviceClickListener {
        ...
        void onApi(BleDevice bleDevice);
    }
