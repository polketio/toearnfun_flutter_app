...
import io.polket.toearnfun_flutter_app.data.BleConnectStateParameter;
import io.polket.toearnfun_flutter_app.data.BleDevice;
import io.polket.toearnfun_flutter_app.data.BleMsg;
import io.polket.toearnfun_flutter_app.exception.ConnectException;
import io.polket.toearnfun_flutter_app.exception.OtherException;
import io.polket.toearnfun_flutter_app.exception.TimeoutException;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case BleMsg.MSG_DISCOVER_SERVICES: {
                    if (bluetoothGatt != null) {
                        @SuppressLint("MissingPermission") boolean discoverServiceResult = bluetoothGatt.discoverServices();
